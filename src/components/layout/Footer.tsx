...
const DEFAULT_FOOTER = {
  logoText: 'Hero',
  companyDescription:
    'Empowering businesses with cutting-edge SaaS solutions. Trusted by over 10,000 companies worldwide to streamline operations and accelerate growth through intelligent automation.',
  contactEmail: 'support@hero.com',
  ...
  section4Title: 'Legal',
  copyrightText: '© 2024 Hero. All rights reserved.',
  madeWithText: 'by the Hero team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/heroplatform',
  social2Href: 'https://facebook.com/heroplatform',
  social3Href: 'https://instagram.com/heroplatform',
  social4Href: 'https://linkedin.com/company/heroplatform',
  social5Href: 'https://github.com/heroplatform',
} as const;
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        { name: 'About Hero', href: '/about', editableId: 'link-footer-about' },
